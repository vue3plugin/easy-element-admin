...
import type { DateModelType } from 'element-plus/lib/components/time-picker/src/common/props.js';
...
<template><!-- type="month" -->
  ...
  <ElSteps class="mt-4" :active="2" finish-status="success">
    <ElStep></ElStep>
    <ElStep></ElStep>
    <ElStep></ElStep>
    <ElStep></ElStep>
  </ElSteps>
  <ElSteps class="mt-4" :active="2" finish-status="error">
    <ElStep></ElStep>
    <ElStep></ElStep>
    <ElStep></ElStep>
    <ElStep></ElStep>
  </ElSteps>
  <ElDatePicker v-model="value"  class="mt-4"/>
  <ElDatePicker v-model="value" type="month" />
  <ElDatePicker v-model="value" type="year" />
  <ElDatePicker v-model="daterange" type="daterange" />
  <ElDatePicker v-model="daterange" type="monthrange" />
  <ElSelect />
  <ElButton>按钮</ElButton>
  ...
  <el-select-v2 :options="options" placeholder="Please select" size="large" />
